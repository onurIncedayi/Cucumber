...
public class _02_GetAllRowColumn extends JDBCParent {
    ...
    public void  test2() throws SQLException {
        // language tablosundaki tum satırları ve tüm sütunları yazdırınız,
        // aynı mysql sonuç ekranında oldugu gibi
        ...
        // % : deüişkenin değerini işaret eder
    ...
    public void test4() throws SQLException {
        // actor tablosundaki tüm satırları ve tüm sütunları yazdırınız, aynı mysql sonuç ekranında oldugu gibi
        // fakat metod kullanınız metoda sorguyu gonderınız ve arada yazdırınız
